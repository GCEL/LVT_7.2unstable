             ...
             if(model%count(t,m_k).gt.0) then
                if(metric%selectOpt.eq.1) then 
                   if(model%value(t,m_k).ne.LVT_rc%udef) then 
                      if(model%value(t,m_k).lt.stats%mintime%model_value_min_total(t,k,1)) then 
                ...
                if(metric%timeOpt.eq.1) then 
                   if(model%value(t,m_k).ne.LVT_rc%udef) then 
                      if(model%value(t,m_k).lt.stats%mintime%model_value_min_ts(t,k,1)) then 
                         stats%mintime%model_value_min_ts(t,k,1) = model%value(t,m_k)
                   ...
                   if(obs%count(t,o_k).gt.0) then 
                      ...
                      if(metric%timeOpt.eq.1.and.obs%value(t,o_k).ne.LVT_rc%udef) then 
                         if(obs%value(t,o_k).lt.&
                            ...
                            stats%mintime%obs_value_min_ts(t,k,1) = obs%value(t,o_k)
                      ...
                      if(metric%computeSC.eq.1.and.obs%value(t,o_k).ne.LVT_rc%udef) then 
                         ...
                         if(obs%value(t,o_k).lt.stats%mintime%obs_value_min_asc(t,k,tind)) then 
                      ...
                      if(metric%computeADC.eq.1.and.obs%value(t,o_k).ne.LVT_rc%udef) then 
                         call LVT_getADCTimeIndex(tind)
                         if(obs%value(t,o_k).lt.stats%mintime%obs_value_min_adc(t,k,tind)) then 
                      ...
                      if(LVT_rc%strat_nlevels.gt.1) then 
                         if(LVT_stats%strat_var(t,k).gt.&
                            ...
                            if(metric%selectOpt.eq.1 &
                               ...
                               if(obs%value(t,o_k).lt.stats%mintime%obs_value_min_total(t,k,2)) then 
                            ...
                            if(metric%timeOpt.eq.1.and.&
                                 obs%value(t,o_k).ne.LVT_rc%udef) then 
                               if(obs%value(t,o_k).lt.stats%mintime%obs_value_min_ts(t,k,2)) then 
                         ...
                         elseif(LVT_stats%strat_var(t,k).le.&
                            ...
                            if(metric%selectOpt.eq.1.and.&
                                 obs%value(t,o_k).ne.LVT_rc%udef) then 
                               if(obs%value(t,o_k).lt.stats%mintime%obs_value_min_total(t,k,3)) then 
                            ...
                            if(metric%timeOpt.eq.1.and.&
                                 obs%value(t,o_k).ne.LVT_rc%udef) then 
                               if(obs%value(t,o_k).lt.stats%mintime%obs_value_min_ts(t,k,3)) then 
