             ...
             if(model%count(t,m_k).gt.0) then
                if(metric%selectOpt.eq.1) then 
                   if(model%value(t,m_k).ne.LVT_rc%udef) then 
                      if(model%value(t,m_k).gt.stats%maxtime%model_value_max_total(t,k,1)) then 
                ...
                if(metric%timeOpt.eq.1) then 
                   if(model%value(t,m_k).ne.LVT_rc%udef) then 
                      if(model%value(t,m_k).gt.stats%maxtime%model_value_max_ts(t,k,1)) then 
                         stats%maxtime%model_value_max_ts(t,k,1) = model%value(t,m_k)
                   ...
                   if(obs%count(t,o_k).gt.0) then 
                      ...
                      if(metric%timeOpt.eq.1.and.obs%value(t,o_k).ne.LVT_rc%udef) then 
                         if(obs%value(t,o_k).gt.&
                            ...
                            stats%maxtime%obs_value_max_ts(t,k,1) = obs%value(t,o_k)
                      ...
                      if(metric%computeSC.eq.1.and.obs%value(t,o_k).ne.LVT_rc%udef) then 
                         ...
                         if(obs%value(t,o_k).gt.stats%maxtime%obs_value_max_asc(t,k,tind)) then 
                      ...
                      if(metric%computeADC.eq.1.and.obs%value(t,o_k).ne.LVT_rc%udef) then 
                         call LVT_getADCTimeIndex(tind)
                         if(obs%value(t,o_k).gt.stats%maxtime%obs_value_max_adc(t,k,tind)) then 
                      ...
                      if(LVT_rc%strat_nlevels.gt.1) then 
                         if(LVT_stats%strat_var(t,k).gt.&
                            ...
                            if(metric%selectOpt.eq.1 &
                               ...
                               if(obs%value(t,o_k).gt.stats%maxtime%obs_value_max_total(t,k,2)) then 
                            ...
                            if(metric%timeOpt.eq.1.and.&
                                 obs%value(t,o_k).ne.LVT_rc%udef) then 
                               if(obs%value(t,o_k).gt.stats%maxtime%obs_value_max_ts(t,k,2)) then 
                         ...
                         elseif(LVT_stats%strat_var(t,k).le.&
                            ...
                            if(metric%selectOpt.eq.1.and.&
                                 obs%value(t,o_k).ne.LVT_rc%udef) then 
                               if(obs%value(t,o_k).gt.stats%maxtime%obs_value_max_total(t,k,3)) then 
                            ...
                            if(metric%timeOpt.eq.1.and.&
                                 obs%value(t,o_k).ne.LVT_rc%udef) then 
                               if(obs%value(t,o_k).gt.stats%maxtime%obs_value_max_ts(t,k,3)) then 
