             ...
             if(model%count(t,m_k).gt.0) then
                if(metric%selectOpt.eq.1) then 
                   if(model%value(t,m_k).ne.LVT_rc%udef) then 
                      if(model%value(t,m_k).lt.stats%min%model_value_total(t,k,1)) then 
                ...
                if(metric%timeOpt.eq.1) then 
                   if(model%value(t,m_k).ne.LVT_rc%udef) then 
                      if(model%value(t,m_k).lt.stats%min%model_value_ts(t,k,1)) then 
                         stats%min%model_value_ts(t,k,1) = model%value(t,m_k)
                      endif
                   endif
                endif
                if(metric%computeSC.eq.1) then 
                   ...
                   if(obs%count(t,o_k).gt.0) then 
                      ...
                      if(metric%timeOpt.eq.1.and.obs%value(t,o_k).ne.LVT_rc%udef) then 
                         if(obs%value(t,o_k).lt.&
                            ...
                            stats%min%obs_value_ts(t,k,1) = obs%value(t,o_k)
                         endif
                      endif
                      if(metric%computeSC.eq.1.and.obs%value(t,o_k).ne.LVT_rc%udef) then 
                         ...
                         if(obs%value(t,o_k).lt.stats%min%obs_value_asc(t,k,tind)) then 
                      ...
                      if(metric%computeADC.eq.1.and.obs%value(t,o_k).ne.LVT_rc%udef) then 
                         call LVT_getADCTimeIndex(tind)
                         if(obs%value(t,o_k).lt.stats%min%obs_value_adc(t,k,tind)) then 
                      ...
                      if(LVT_rc%strat_nlevels.gt.1) then 
                         if(LVT_stats%strat_var(t,k).gt.&
                            ...
                            if(metric%selectOpt.eq.1 &
                               ...
                               if(obs%value(t,o_k).lt.stats%min%obs_value_total(t,k,2)) then 
                            ...
                            if(metric%timeOpt.eq.1.and.&
                                 obs%value(t,o_k).ne.LVT_rc%udef) then 
                               if(obs%value(t,o_k).lt.stats%min%obs_value_ts(t,k,2)) then 
                         ...
                         elseif(LVT_stats%strat_var(t,k).le.&
                            ...
                            if(metric%selectOpt.eq.1.and.&
                                 obs%value(t,o_k).ne.LVT_rc%udef) then 
                               if(obs%value(t,o_k).lt.stats%min%obs_value_total(t,k,3)) then 
                            ...
                            if(metric%timeOpt.eq.1.and.&
                                 obs%value(t,o_k).ne.LVT_rc%udef) then 
                               if(obs%value(t,o_k).lt.stats%min%obs_value_ts(t,k,3)) then 
