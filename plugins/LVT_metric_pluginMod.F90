...
! !INTERFACE:
  subroutine LVT_metric_plugin
    ...
    use LVT_MaxTimeMod, only : LVT_initMaxTime, LVT_diagnoseMaxTime, LVT_computeMaxTime,&
         LVT_writeMetric_MaxTime, LVT_resetMetric_MaxTime, LVT_writerestart_MaxTime, &
         LVT_readrestart_MaxTime
    ...
    use LVT_TendencyMod, only : LVT_initTendency, LVT_diagnoseTendency,&
         LVT_computeTendency,&
         LVT_writeMetric_Tendency, LVT_resetMetric_Tendency, LVT_writerestart_Tendency, &
         LVT_readrestart_Tendency

    use LVT_TendencyCorrMod, only : LVT_initTendencyCorr, LVT_diagnoseTendencyCorr,&
         LVT_computeTendencyCorr,&
         LVT_writeMetric_TendencyCorr, LVT_resetMetric_TendencyCorr, LVT_writerestart_TendencyCorr, &
         LVT_readrestart_TendencyCorr
