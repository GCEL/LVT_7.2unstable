...
!EOP
  ...
  type(lisrcdec),                  save :: LVT_LIS_rc(2)
  type(lvt_domain_type),           save :: LVT_domain
  type(lis_domain_type),           save :: LVT_LIS_domain(2)
  ...
  type(ESMF_Grid), save                 :: LVT_vecTile(2)
  type(ESMF_Grid), allocatable          :: LVT_vecPatch(:,:)
  type(ESMF_Grid), save                 :: LVT_vecGrid(2)
  type(ESMF_Grid), save                 :: LVT_ensOnGrid(2)
...
!-------------------------------------------------------------------------
       ...
       elseif(LVT_rc%timeAvgOpt.eq.1) then !time averaged variable
