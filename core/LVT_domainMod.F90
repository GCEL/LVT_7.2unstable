...
!EOP
    ...
    do r=1,LVT_LIS_rc(source)%gnr     
       do c=1,LVT_LIS_rc(source)%gnc             
          do m=1,LVT_LIS_rc(source)%nensem
             if(LVT_LMLC(source)%landmask(c,r).gt.0) then
    ...
    do r=1,LVT_LIS_rc(source)%gnr
       do c=1,LVT_LIS_rc(source)%gnc
          if(LVT_LMLC(source)%landmask(c,r).gt.0.and.&
          ...
          elseif(LVT_LMLC(source)%landmask(c,r).gt.0.and.&
             ...
             write(LVT_logunit,*) '[ERR] mask ',LVT_LMLC(source)%landmask(c,r)
