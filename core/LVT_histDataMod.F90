...
!derived
  ...
  integer :: LVT_MOC_SWNET(2)      = -9999
  integer :: LVT_MOC_LWNET(2)      = -9999
  integer :: LVT_MOC_QLE(2)        = -9999
  integer :: LVT_MOC_QH(2)         = -9999
  integer :: LVT_MOC_QG(2)         = -9999
  integer :: LVT_MOC_QF(2)         = -9999
  integer :: LVT_MOC_QV(2)         = -9999
  integer :: LVT_MOC_QTAU(2)       = -9999
  integer :: LVT_MOC_QA(2)         = -9999
  integer :: LVT_MOC_DELSURFHEAT(2) = -9999
  integer :: LVT_MOC_DELCOLDCONT(2) = -9999

   ! ALMA WATER BALANCE COMPONENTS
  integer :: LVT_MOC_SNOWF(2)      = -9999
  integer :: LVT_MOC_RAINF(2)      = -9999
  integer :: LVT_MOC_EVAP(2)       = -9999
  integer :: LVT_MOC_QS(2)         = -9999
  integer :: LVT_MOC_QREC(2)       = -9999
  integer :: LVT_MOC_QSB(2)        = -9999
  integer :: LVT_MOC_QSM(2)        = -9999
  integer :: LVT_MOC_QFZ(2)        = -9999
  integer :: LVT_MOC_QST(2)        = -9999
  integer :: LVT_MOC_DELSOILMOIST(2) = -9999
  integer :: LVT_MOC_DELSWE(2)     = -9999
  integer :: LVT_MOC_DELSURFSTOR(2)  = -9999
  integer :: LVT_MOC_DELINTERCEPT(2) = -9999

   ! ALMA SURFACE STATE VARIABLES
  integer :: LVT_MOC_SNOWT(2)      = -9999
  integer :: LVT_MOC_VEGT(2)       = -9999
  integer :: LVT_MOC_BARESOILT(2)  = -9999
  integer :: LVT_MOC_AVGSURFT(2)   = -9999
  integer :: LVT_MOC_RADT(2)       = -9999
  integer :: LVT_MOC_ALBEDO(2)     = -9999
  integer :: LVT_MOC_SWE(2)        = -9999
  integer :: LVT_MOC_SWEVEG(2)     = -9999 
  integer :: LVT_MOC_SURFSTOR(2)   = -9999

   ! ALMA SUBSURFACE STATE VARIABLES
   integer :: LVT_MOC_SOILMOIST(2)  = -9999
   integer :: LVT_MOC_SOILTEMP(2)   = -9999
   integer :: LVT_MOC_SMLIQFRAC(2)  = -9999
   integer :: LVT_MOC_SMFROZFRAC(2) = -9999
   integer :: LVT_MOC_SOILWET(2)    = -9999

   ! ALMA EVAPORATION COMPONENTS
   integer :: LVT_MOC_POTEVAP(2)    = -9999
   integer :: LVT_MOC_ECANOP(2)     = -9999
   integer :: LVT_MOC_TVEG(2)       = -9999
   integer :: LVT_MOC_ESOIL(2)      = -9999
   integer :: LVT_MOC_EWATER(2)     = -9999
   integer :: LVT_MOC_ROOTMOIST(2)  = -9999
   integer :: LVT_MOC_CANOPINT(2)   = -9999
   integer :: LVT_MOC_EVAPSNOW(2)   = -9999
   integer :: LVT_MOC_SUBSNOW(2)    = -9999
   integer :: LVT_MOC_SUBSURF(2)    = -9999
   integer :: LVT_MOC_ACOND(2)      = -9999

   ! ALMA OTHER HYDROLOGIC VARIABLES
  integer :: LVT_MOC_WATERTABLED(2)= -9999
  integer :: LVT_MOC_TWS(2)        = -9999
  integer :: LVT_MOC_GWS(2)        = -9999
  integer :: LVT_MOC_WT(2)         = -9999

   ! ALMA COLD SEASON PROCESSES
  integer :: LVT_MOC_SNOWCOVER(2)  = -9999
  integer :: LVT_MOC_SALBEDO(2)    = -9999
  integer :: LVT_MOC_SNOWTPROF(2)  = -9999
  integer :: LVT_MOC_SNOWDEPTH(2)  = -9999
  integer :: LVT_MOC_SLIQFRAC(2)   = -9999

   ! ALMA VARIABLES TO BE COMPARED WITH REMOTE SENSED DATA
   integer :: LVT_MOC_LWUP(2)       = -9999

   ! ALMA CARBON VARIABLES
   integer :: LVT_MOC_GPP(2)        = -9999
   integer :: LVT_MOC_NPP(2)        = -9999
   integer :: LVT_MOC_NEE(2)        = -9999
   integer :: LVT_MOC_AUTORESP(2)   = -9999
   integer :: LVT_MOC_HETERORESP(2) = -9999
   integer :: LVT_MOC_LEAFRESP(2)   = -9999
   integer :: LVT_MOC_TOTSOILCARB(2)= -9999
   integer :: LVT_MOC_TOTLIVBIOM(2) = -9999

   ! ALMA FORCING VARIABLES
   integer :: LVT_MOC_WINDFORC(2)   = -9999
   integer :: LVT_MOC_RAINFFORC(2)  = -9999
   integer :: LVT_MOC_SNOWFFORC(2)  = -9999
   integer :: LVT_MOC_CRAINFFORC(2) = -9999
   integer :: LVT_MOC_TAIRFORC(2)   = -9999
   integer :: LVT_MOC_QAIRFORC(2)   = -9999
   integer :: LVT_MOC_PSURFFORC(2)  = -9999
   integer :: LVT_MOC_SWDOWNFORC(2) = -9999
   integer :: LVT_MOC_LWDOWNFORC(2) = -9999

   ! CLSM FORCING VARIABLES
   integer :: LVT_MOC_PARDRFORC(2)  = -9999
   integer :: LVT_MOC_PARDFFORC(2)  = -9999

   ! PARAMETER OUTPUT - EXPERIMENTAL (USE W/WRF-WPS)
   integer :: LVT_MOC_LANDMASK(2)   = -9999
   integer :: LVT_MOC_LANDCOVER(2)  = -9999
   integer :: LVT_MOC_SOILTYPE(2)   = -9999
   integer :: LVT_MOC_SANDFRAC(2)   = -9999
   integer :: LVT_MOC_CLAYFRAC(2)   = -9999
   integer :: LVT_MOC_SILTFRAC(2)   = -9999
   integer :: LVT_MOC_POROSITY(2)   = -9999
   integer :: LVT_MOC_SOILCOLOR(2)  = -9999
   integer :: LVT_MOC_ELEVATION(2)  = -9999
   integer :: LVT_MOC_SLOPE(2)      = -9999
   integer :: LVT_MOC_ASPECT(2)     = -9999
   integer :: LVT_MOC_LAI(2)        = -9999
   integer :: LVT_MOC_SAI(2)        = -9999
   integer :: LVT_MOC_SNFRALBEDO(2) = -9999
   integer :: LVT_MOC_MXSNALBEDO(2) = -9999
   integer :: LVT_MOC_GREENNESS(2)  = -9999
   integer :: LVT_MOC_NDVI(2)       = -9999
   integer :: LVT_MOC_SIF(2)       = -9999
   integer :: LVT_MOC_TEMPBOT(2)   = -9999

   ! NLDAS OUTPUT
   integer :: LVT_MOC_CCOND(2)    = -9999

   ! ADDITIONAL AFWA VARIABLES
   integer :: LVT_MOC_RELSMC(2)       = -9999
   integer :: LVT_MOC_RHMIN(2)        = -9999
   integer :: LVT_MOC_ROOTTEMP(2)  = -9999
   integer :: LVT_MOC_TOTALPRECIP(2) = -9999
   integer :: LVT_MOC_RAINFCONV(2) = -9999

   ! multivariate diagnostics (Bowen Ratio, Evaporative fraction)
   integer :: LVT_MOC_BR(2) = -9999
   integer :: LVT_MOC_EF(2) = -9999

   ! ADDITIONAL COUPLING FORCING VARIABLES
   integer :: LVT_MOC_DIRECTSWFORC(2)  = -9999
   integer :: LVT_MOC_DIFFUSESWFORC(2) = -9999
   integer :: LVT_MOC_NWINDFORC(2)     = -9999
   integer :: LVT_MOC_EWINDFORC(2)     = -9999
   integer :: LVT_MOC_FHEIGHTFORC(2)   = -9999
   integer :: LVT_MOC_CHFORC(2)        = -9999
   integer :: LVT_MOC_CMFORC(2)        = -9999
   integer :: LVT_MOC_EMISSFORC(2)     = -9999
   integer :: LVT_MOC_MIXRATIOFORC(2)  = -9999
   integer :: LVT_MOC_COSZENFORC(2)    = -9999
   integer :: LVT_MOC_ALBEDOFORC(2)    = -9999

   integer :: LVT_MOC_DR_CATEGORY(2)   = -9999
   integer :: LVT_MOC_PERCENTILE(2)   = -9999

   ! ADDITIONAL Noah3.x variables
   integer :: LVT_MOC_SOILET(2)  = -9999
   integer :: LVT_MOC_Z0BRD(2)   = -9999
   integer :: LVT_MOC_ROUGHNESS(2)   = -9999

   !t2,q2 diagnostics
   integer :: LVT_MOC_T2DIAG(2) = -9999
   integer :: LVT_MOC_Q2DIAG(2) = -9999
   integer :: LVT_MOC_RNET(2) = -9999
   integer :: LVT_MOC_CH(2)     = -9999
   integer :: LVT_MOC_CM(2)     = -9999
   integer :: LVT_MOC_MIXRATIO(2) = -9999

!<for vic>
   !Additional VIC forcing variables
   integer :: LVT_MOC_SNOWFLAGFORC(2)          = -9999
   integer :: LVT_MOC_DENSITYFORC(2)           = -9999
   integer :: LVT_MOC_VAPORPRESSFORC(2)        = -9999
   integer :: LVT_MOC_VAPORPRESSDEFICITFORC(2) = -9999
   integer :: LVT_MOC_ARESIST(2)               = -9999
!</for vic>

   ! Sacrament/Snow17 variables
   integer :: LVT_MOC_SACQS(2)             = -9999
   integer :: LVT_MOC_SACQSB(2)            = -9999
   integer :: LVT_MOC_SACSWE(2)            = -9999
   integer :: LVT_MOC_SACPOTEVAP(2)        = -9999
   integer :: LVT_MOC_SACEVAP(2)           = -9999
   integer :: LVT_MOC_SACUZTWC(2)          = -9999
   integer :: LVT_MOC_SACUZFWC(2)          = -9999
   integer :: LVT_MOC_SACLZTWC(2)          = -9999
   integer :: LVT_MOC_SACLZFSC(2)          = -9999
   integer :: LVT_MOC_SACLZFPC(2)          = -9999
   integer :: LVT_MOC_SACADIMPC(2)         = -9999
   !integer :: LVT_MOC_SACSOILMOIST1     = -9999
   integer :: LVT_MOC_SACSOILMOIST2(2)     = -9999
   !integer :: LVT_MOC_SACSOILMOIST3     = -9999
   integer :: LVT_MOC_SACSOILMOIST4(2)     = -9999
   integer :: LVT_MOC_SACSOILMOIST5(2)     = -9999
   !integer :: LVT_MOC_SACSOILMOIST6     = -9999
   integer :: LVT_MOC_SACSOILTEMP1(2)      = -9999
   integer :: LVT_MOC_SACSOILTEMP2(2)      = -9999
   integer :: LVT_MOC_SACSFRAC(2)          = -9999
   integer :: LVT_MOC_SACSDEPTH(2)         = -9999
   integer :: LVT_MOC_SACUZTWM(2)          = -9999
   integer :: LVT_MOC_SACUZFWM(2)          = -9999
   integer :: LVT_MOC_SACLZTWM(2)          = -9999
   integer :: LVT_MOC_SACLZFSM(2)          = -9999
   integer :: LVT_MOC_SACLZFPM(2)          = -9999
   integer :: LVT_MOC_SACADIMP(2)          = -9999
   integer :: LVT_MOC_SACRAINF(2)          = -9999
   integer :: LVT_MOC_SACTAIR(2)           = -9999
   integer :: LVT_MOC_SNOW17SWE(2)         = -9999
   integer :: LVT_MOC_SNOW17TWE(2)         = -9999
   integer :: LVT_MOC_SNOW17AEADJ(2)       = -9999
   integer :: LVT_MOC_SNOW17SWEINCR(2)     = -9999
   integer :: LVT_MOC_SNOW17WEINCR(2)      = -9999
   integer :: LVT_MOC_SNOW17TWEINCR(2)     = -9999
   integer :: LVT_MOC_SNOW17SFRAC1(2)      = -9999
   integer :: LVT_MOC_SNOW17NEGHS(2)       = -9999
   integer :: LVT_MOC_SNOW17LIQW(2)        = -9999
   integer :: LVT_MOC_SNOW17DS(2)          = -9999
   integer :: LVT_MOC_SNOW17AESCINCR(2)    = -9999
   integer :: LVT_MOC_SNOW17CNHS(2)        = -9999
   integer :: LVT_MOC_SNOW17SFRAC4(2)      = -9999
   integer :: LVT_MOC_SNOW17ACCMAX(2)      = -9999
   integer :: LVT_MOC_SNOW17SFRAC6(2)      = -9999
   integer :: LVT_MOC_SNOW17SFRAC7(2)      = -9999
   integer :: LVT_MOC_SNOW17SFRAC8(2)      = -9999
   integer :: LVT_MOC_SNOW17SFRAC9(2)      = -9999
   integer :: LVT_MOC_SNOW17SFRAC10(2)     = -9999
   integer :: LVT_MOC_SNOW17SFRAC11(2)     = -9999
   integer :: LVT_MOC_SNOW17SFRAC12(2)     = -9999
   integer :: LVT_MOC_SNOW17SFRAC13(2)     = -9999
   integer :: LVT_MOC_SNOW17SFRAC14(2)     = -9999
   integer :: LVT_MOC_SNOW17SFRAC15(2)     = -9999
   integer :: LVT_MOC_SNOW17RAINF(2)       = -9999
   integer :: LVT_MOC_SNOW17SNOWF(2)       = -9999
   integer :: LVT_MOC_SNOW17TAIR(2)        = -9999
   integer :: LVT_MOC_SNOW17RMLT(2)        = -9999
   integer :: LVT_MOC_SNOW17RMINCR(2)      = -9999
   
   integer ::   LVT_MOC_SACUZTWH(2)  = -9999
   integer ::   LVT_MOC_SACUZFWH(2)  = -9999
   integer ::   LVT_MOC_SACLZTWH(2)  = -9999
   integer ::   LVT_MOC_SACLZFSH(2)  = -9999
   integer ::   LVT_MOC_SACLZFPH(2)  = -9999
   
   integer ::   LVT_MOC_SACSWINT(2)  = -9999
   integer ::   LVT_MOC_SACTSINT(2)  = -9999
   integer ::   LVT_MOC_SACSWHINT(2)  = -9999
   integer ::   LVT_MOC_SACFROST(2)  = -9999

!Noah-MP variables
   integer ::   LVT_MOC_LEAFMASS(2)  = -9999
   integer ::   LVT_MOC_ROOTMASS(2)  = -9999
   integer ::   LVT_MOC_STEMMASS(2)  = -9999
   integer ::   LVT_MOC_WOODMASS(2)  = -9999
   integer ::   LVT_MOC_CARBON_DEEPSOIL(2)  = -9999
   integer ::   LVT_MOC_CARBON_SHALLOWSOIL(2)  = -9999

!<for vic>
   integer :: LVT_MOC_VIC_PET_SATSOIL(2)   = -9999
   integer :: LVT_MOC_VIC_PET_H2OSURF(2)   = -9999
   integer :: LVT_MOC_VIC_PET_SHORT(2)     = -9999
   integer :: LVT_MOC_VIC_PET_TALL(2)      = -9999
   integer :: LVT_MOC_VIC_PET_NATVEG(2)    = -9999
   integer :: LVT_MOC_VIC_PET_VEGNOCR(2)   = -9999
!</for vic>

   !FLDAS
   integer :: LVT_MOC_PETFORC(2)         = -9999
   integer :: LVT_MOC_REFETFORC(2)       = -9999

   ! FLDAS-WRSI OUTPUTS LIST
   integer :: LVT_MOC_REFET(2) = -9999
   integer :: LVT_MOC_ETa(2) = -9999
   integer :: LVT_MOC_SOS(2) = -9999
   integer :: LVT_MOC_WRSI(2) = -9999
   integer :: LVT_MOC_KF2(2) = -9999
   integer :: LVT_MOC_SumWR(2) = -9999
   integer :: LVT_MOC_SumET(2) = -9999
   integer :: LVT_MOC_SWI(2) = -9999
   integer :: LVT_MOC_SOSa(2) = -9999
   integer :: LVT_MOC_TotalSurplusWater(2) = -9999
   integer :: LVT_MOC_MaxSurplusWater(2) = -9999
   integer :: LVT_MOC_TotalWaterDeficit(2) = -9999
   integer :: LVT_MOC_MaxWaterDeficit(2) = -9999
   integer :: LVT_MOC_TotalAETInitial(2) = -9999
   integer :: LVT_MOC_TotalWRInitial(2) = -9999
   integer :: LVT_MOC_TotalSurplusWaterInitial(2) = -9999
   integer :: LVT_MOC_TotalWaterDeficitInitial(2) = -9999
   integer :: LVT_MOC_TotalAETVeg(2) = -9999
   integer :: LVT_MOC_TotalWRVeg(2) = -9999
   integer :: LVT_MOC_TotalSurplusWaterVeg(2) = -9999
   integer :: LVT_MOC_TotalWaterDeficitVeg(2) = -9999
   integer :: LVT_MOC_TotalAETFlower(2) = -9999
   integer :: LVT_MOC_TotalWRFlower(2) = -9999
   integer :: LVT_MOC_TotalSurplusWaterFlower(2) = -9999
   integer :: LVT_MOC_TotalWaterDeficitFlower(2) = -9999
   integer :: LVT_MOC_TotalAETRipe(2) = -9999
   integer :: LVT_MOC_TotalWRRipe(2) = -9999
   integer :: LVT_MOC_TotalSurplusWaterRipe(2) = -9999
   integer :: LVT_MOC_TotalWaterDeficitRipe(2) = -9999
   integer :: LVT_MOC_PermWiltDate(2) = -9999
   integer :: LVT_MOC_Wilting1(2) = -9999
   integer :: LVT_MOC_Wilting2(2) = -9999
   integer :: LVT_MOC_WRSIa(2) = -9999
   integer :: LVT_MOC_growing_season(2) = -9999
   integer :: LVT_MOC_WHC(2)                      = -9999
   integer :: LVT_MOC_LGP(2)                      = -9999
   integer :: LVT_MOC_WR_TimeStep(2)              = -9999 ! SY
   integer :: LVT_MOC_AET_TimeStep(2)             = -9999 ! SY
   integer :: LVT_MOC_WRSI_TimeStep(2)            = -9999 ! SY
   integer :: LVT_MOC_SurplusWater_TimeStep(2)    = -9999 ! SY

   !NLDAS
   integer :: LVT_MOC_CAPEFORC(2)         = -9999

   integer :: LVT_MOC_LAKE_T_SNOW(2)    =   -9999
   integer :: LVT_MOC_LAKE_T_ICE(2) =   -9999
   integer :: LVT_MOC_LAKE_T_MNW(2) =   -9999
   integer :: LVT_MOC_LAKE_T_WML(2) =   -9999
   integer :: LVT_MOC_LAKE_T_BOT(2) =   -9999
   integer :: LVT_MOC_LAKE_T_B1 (2) =   -9999
   integer :: LVT_MOC_LAKE_C_T(2)   =   -9999
   integer :: LVT_MOC_LAKE_H_SNOW(2)    =   -9999
   integer :: LVT_MOC_LAKE_H_ICE(2) =   -9999
   integer :: LVT_MOC_LAKE_H_ML(2)  =   -9999
   integer :: LVT_MOC_LAKE_H_B1(2)  =   -9999
   integer :: LVT_MOC_LAKE_T_SFC(2) =   -9999
   integer :: LVT_MOC_LAKE_ALBEDO_WATER(2)  =   -9999
   integer :: LVT_MOC_LAKE_ALBEDO_ICE(2)    =   -9999
   integer :: LVT_MOC_LAKE_ALBEDO_SNOW(2)   =   -9999
   integer :: LVT_MOC_LAKE_UFR_A(2) =   -9999
   integer :: LVT_MOC_LAKE_UFR_W(2) =   -9999
   integer :: LVT_MOC_LAKE_WCONV(2) =   -9999
   integer :: LVT_MOC_LAKE_Q_SE(2)  =   -9999
   integer :: LVT_MOC_LAKE_Q_LA(2)  =   -9999
   integer :: LVT_MOC_LAKE_I_W(2)   =   -9999
   integer :: LVT_MOC_LAKE_Q_LWA(2) =   -9999
   integer :: LVT_MOC_LAKE_Q_LWW(2) =   -9999
   integer :: LVT_MOC_LAKE_Q_BOT(2) =   -9999

   integer :: LVT_MOC_EBAL(2)                     = -9999 
   integer :: LVT_MOC_WBAL(2)                     = -9999 
   integer :: LVT_MOC_EVAPBAL(2)                  = -9999 
   integer :: LVT_MOC_SWEOVERP(2)                 = -9999
   integer :: LVT_MOC_ETOVERP(2)                  = -9999
   integer :: LVT_MOC_QSOVERP(2)                  = -9999
   integer :: LVT_MOC_QSBOVERP(2)                 = -9999
   integer :: LVT_MOC_RUNOFF(2)                   = -9999

   integer :: LVT_MOC_ECANOPOVERQLE(2)     = -9999
   integer :: LVT_MOC_TVEGOVERQLE(2)     = -9999
   integer :: LVT_MOC_ESOILOVERQLE(2)     = -9999

   integer :: LVT_MOC_STREAMFLOW(2) = -9999
   integer :: LVT_MOC_RIVSTO(2) = -9999
   integer :: LVT_MOC_RIVDPH(2) = -9999
   integer :: LVT_MOC_RIVVEL(2) = -9999
   integer :: LVT_MOC_FLDOUT(2) = -9999
   integer :: LVT_MOC_FLDEVAP(2) = -9999
   integer :: LVT_MOC_FLDSTO(2) = -9999
   integer :: LVT_MOC_FLDDPH(2) = -9999
   integer :: LVT_MOC_FLDVEL(2) = -9999
   integer :: LVT_MOC_FLDFRC(2) = -9999
   integer :: LVT_MOC_FLDARE(2) = -9999
   integer :: LVT_MOC_SFCELV(2) = -9999
   integer :: LVT_MOC_RNFSTO(2) = -9999
   integer :: LVT_MOC_BSFSTO(2) = -9999

   !variables related to RTMs
   integer :: LVT_MOC_RTM_EMISSIVITY(2)           = -9999 
   integer :: LVT_MOC_RTM_TB(2)                   = -9999 
   integer :: LVT_MOC_RTM_SM(2)                   = -9999 

   !DA diagnostics
   integer :: LVT_MOC_DA_ENSSPREAD(2)  = -9999
   integer :: LVT_MOC_DA_INCR(2)  = -9999
   integer :: LVT_MOC_DA_NINNOV(2)  = -9999
   integer :: LVT_MOC_DA_OBSCOUNT(2)  = -9999

   integer :: LVT_MOC_IRRIGATEDWATER(2)           = -9999 

   integer :: LVT_MOC_COUNT(2)
...
!EOP
    ...
    logical           :: file_exists
    logical           :: table_found
    character*20, allocatable :: ds1_name(:), ds1_unit(:), ds1_dir(:)
    integer,      allocatable :: ds1_startNlevs(:),ds1_endNlevs(:), &
         ds1_vlevels(:),ds1_timeAvgOpt(:)
    character*20, allocatable :: ds2_name(:), ds2_unit(:), ds2_dir(:)
    integer,      allocatable :: ds2_startNlevs(:),ds2_endNlevs(:), &
         ds2_vlevels(:),ds2_timeAvgOpt(:)
...
!--------------------------------------------------------------------------
    ...
    if(LVT_rc%computeEnsMetrics.eq.1) then 
       if(LVT_rc%obssource(1).eq."LIS output") then 
          LVT_rc%npts = LVT_LIS_rc(1)%ntiles
       elseif(LVT_rc%obssource(2).eq."LIS output") then 
          LVT_rc%npts = LVT_LIS_rc(2)%ntiles
       endif
    else
    ...
    allocate(ds1_name(file_lines))
    allocate(ds1_startNlevs(file_lines))
    allocate(ds1_endNlevs(file_lines))
    allocate(ds1_unit(file_lines))
    allocate(ds1_dir(file_lines))
    allocate(ds1_timeAvgOpt(file_lines))
    allocate(ds1_vlevels(file_lines))

    allocate(ds2_name(file_lines))
    allocate(ds2_startNlevs(file_lines))
    allocate(ds2_endNlevs(file_lines))
    allocate(ds2_unit(file_lines))
    allocate(ds2_dir(file_lines))
    allocate(ds2_timeAvgOpt(file_lines))
    allocate(ds2_vlevels(file_lines))

    call ESMF_ConfigFindLabel(LVT_config,&
         "LVT datastream attributes table::",rc=rc)
    do i=1,file_lines
       call ESMF_ConfigNextLine(LVT_config, rc=rc)
       call ESMF_ConfigGetAttribute(LVT_config, ds1_name(i),rc=rc)
       call ESMF_ConfigGetAttribute(LVT_config, ds1_startNlevs(i),rc=rc)
       call ESMF_ConfigGetAttribute(LVT_config, ds1_endNlevs(i),rc=rc)
       call ESMF_ConfigGetAttribute(LVT_config, ds1_unit(i),rc=rc)
       call ESMF_ConfigGetAttribute(LVT_config, ds1_dir(i),rc=rc)
       call ESMF_ConfigGetAttribute(LVT_config, ds1_timeAvgOpt(i),rc=rc)
       call ESMF_ConfigGetAttribute(LVT_config, ds1_vlevels(i),rc=rc)

       call ESMF_ConfigGetAttribute(LVT_config, ds2_name(i),rc=rc)
       call ESMF_ConfigGetAttribute(LVT_config, ds2_startNlevs(i),rc=rc)
       call ESMF_ConfigGetAttribute(LVT_config, ds2_endNlevs(i),rc=rc)
       call ESMF_ConfigGetAttribute(LVT_config, ds2_unit(i),rc=rc)
       call ESMF_ConfigGetAttribute(LVT_config, ds2_dir(i),rc=rc)
       call ESMF_ConfigGetAttribute(LVT_config, ds2_timeAvgOpt(i),rc=rc)
       call ESMF_ConfigGetAttribute(LVT_config, ds2_vlevels(i),rc=rc)

       call register_dataEntry(LVT_MOC_COUNT, nsize,&
            LVT_histData%head_ds1_list,LVT_histData%head_ds2_list,&
            LVT_histData%head_stats_list,&
            ds1_name(i), ds1_startNlevs(i), ds1_endNlevs(i),&
            ds1_unit(i),&
            ds1_dir(i), ds1_timeAvgOpt(i), ds1_vlevels(i),&
            ds2_name(i), ds2_startNlevs(i), ds2_endNlevs(i),&
            ds2_unit(i), &
            ds2_dir(i), ds2_timeAvgOpt(i), ds2_vlevels(i))

    enddo

    deallocate(ds1_name)
    deallocate(ds1_startNlevs)
    deallocate(ds1_endNlevs)
    deallocate(ds1_unit)
    deallocate(ds1_dir)
    deallocate(ds1_timeAvgOpt)
    deallocate(ds1_vlevels)

    deallocate(ds2_name)
    deallocate(ds2_startNlevs)
    deallocate(ds2_endNlevs)
    deallocate(ds2_unit)
    deallocate(ds2_dir)
    deallocate(ds2_timeAvgOpt)
    deallocate(ds2_vlevels)

    allocate(LVT_histData%ptr_into_ds1_list(LVT_MOC_COUNT(1)))

    allocate(LVT_histData%ptr_into_ds2_list(LVT_MOC_COUNT(2)))

    max_count = max(LVT_MOC_COUNT(1),LVT_MOC_COUNT(2))
...
! !INTERFACE: 
 subroutine register_dataEntry(var_count, nsize, &
       head_ds1Entry, head_ds2Entry,head_statsEntry,&
       ds1_name, ds1_startNlevs, ds1_endNlevs, ds1_unit, &
       ds1_dir, ds1_timeAvgOpt, ds1_vlevels,&
       ds2_name, ds2_startNlevs, ds2_endNlevs, ds2_unit, &
       ds2_dir, ds2_timeAvgOpt, ds2_vlevels)
...
!    
   ...
   character(len=*)                 :: ds1_name, ds2_name
   integer                          :: ds1_startNlevs, ds2_startNlevs
   integer                          :: ds1_endNlevs, ds2_endNlevs
   character(len=*)                 :: ds1_unit, ds2_unit
   character(len=*)                 :: ds1_dir, ds2_dir
   integer                          :: ds1_timeAvgOpt, ds2_timeAvgOpt
   integer                          :: ds1_vlevels, ds2_vlevels
...
!    \item[ds1\_name]
!       name of the datastream 1 variable
!    \item[ds1\_selectNlevs]
!       number of selected levels of the datastream 1 variable
!    \item[ds1\_unit]
!       unit of the datastream 1 variable
!    \item[ds1\_dir]
!       direction of the datastream 1 variable
!    \item[ds1\_timeAvgOpt]
!       time averaging specification of the datastream 1 variable
!    \item[ds1\_vlevels]
!       total number of levels of the datastream 1 variable
!    \item[ds2\_name]
!       name of the datastream 2 variable
!    \item[ds2\_selectNlevs]
!       number of selected levels of the datastream 2 variable
!    \item[ds2\_unit]
!       unit of the datastream 2 variable
!    \item[ds2\_dir]
!       direction of the datastream 2 variable
!    \item[ds2\_timeAvgOpt]
!       time averaging specification of the datastream 2 variable
!    \item[ds2\_vlevels]
!       total number of levels of the datastream 2 variable
!  \end{description}
!
!   The routines invoked are: 
!   \begin{description}
...
!EOP
   ...
   if(ds1_startNlevs.ne.0) then 
      ...
      ds1dataEntry%short_name    = ds1_name
      ds1dataEntry%startNlevs    = ds1_startNlevs
      ds1dataEntry%endNlevs      = ds1_endNlevs
      ds1dataEntry%selectNlevs   = ds1_endNlevs - ds1_startNlevs + 1
      ds1dataEntry%units         = ds1_unit
      ds1dataEntry%dir           = ds1_dir
      ds1dataEntry%timeAvgOpt    = ds1_timeAvgOpt
      ds1dataEntry%vlevels       = ds1_vlevels
      ds1dataEntry%computeVar    = 0 

      call updateDataEntryMetaData(1, ds1_name, var_count(1), &
           ds1dataEntry)
      ...
      allocate(ds1dataEntry%value(nsize,ds1dataEntry%vlevels))
      allocate(ds1dataEntry%count(nsize,ds1dataEntry%vlevels))
   ...
   if(ds2_startNlevs.ge.1) then 
      ...
      ds2dataEntry%short_name    = ds2_name
      ds2dataEntry%startNlevs    = ds2_startNlevs
      ds2dataEntry%endNlevs      = ds2_endNlevs
      ds2dataEntry%selectNlevs   = ds2_endNlevs - ds2_startNlevs + 1
      ds2dataEntry%units         = ds2_unit
      ds2dataEntry%dir           = ds2_dir
      ds2dataEntry%timeAvgOpt    = ds2_timeAvgOpt
      ds2dataEntry%vlevels       = ds2_vlevels
      ds2dataEntry%computeVar    = 0 

      call updateDataEntryMetaData(2, ds2_name, var_count(2), &
           ds2dataEntry)
      ...
      allocate(ds2dataEntry%value(nsize,ds2dataEntry%vlevels))
      allocate(ds2dataEntry%count(nsize,ds2dataEntry%vlevels))
...
!stats data structures
   if(ds1_startNlevs.ge.1.or.ds2_startNlevs.ge.1) then 
      allocate(statsEntry)
      ...
      if (LVT_rc%obssource(2).eq."none") then
         ...
         statsEntry%short_name    = trim(ds1_name)
         statsEntry%units         = trim(ds1_unit)
      ...
      statsEntry%short_name    = trim(ds1_name)//"_v_"//trim(ds2_name)
      statsEntry%units         = trim(ds1_unit)//"_v_"//trim(ds2_unit)
      statsEntry => head_statsEntry
      endif
...
! 
! !INTERFACE: 
  subroutine set_ptr_into_list(var_count, ds1head, ds1array, ds2Head, ds2Array)
     implicit none
! !ARGUMENTS:
     integer                                 :: var_count(2)
    ...
    if(index(source).gt.0) then 
       ...
       if(source.eq.1) then 
          call logSingleVar(LVT_MOC_COUNT(1),&
               LVT_histData%ptr_into_ds1_list,&
               index(source), value_inp, vlevel, units, dir_flag, dir,&
...
! !INTERFACE:
  subroutine logSingleVar(var_count,ptr_into_list, index, value_inp,&
       vlevel,units,dir_flag, dir,stdev_flag,stdev)
! 
! !USES: 
